...
RUN apk add --no-cache texlive-full gmp libffi zlib pcre cmark@testing R R-dev curl openssl-dev curl-dev gcc g++ git coreutils libxml2-dev openssh ghostscript graphviz perl gnuplot &&\
